...
export function TableTr(props){
    var style = ''
    const [custom, setCustom]  =  useState("of");
    ...
    return(
        <tr className="bgc-h-yellow-l4 d-style">
            ...
            <td width="5%"><span className="badge bgc-white border-1 border-l-3 brc-success-m2 btn-text-success text-70">{props.tr.type}</span></td>
            <td width="30%">{props.tr.goal}</td>
            <td width="10%">{props.tr.team}</td>
            <td width="10%">{props.tr.owner}</td>
            <td width="5%" className="d-none d-sm-table-cell text-center">{props.tr.priority}</td>
